...
🎯 목표
VM에서 GitHub SSH 인증 성공
기존 HTTPS remote → SSH remote 변경
git push 시 인증 입력 없이 정상 동작
...
<img width="914" height="688" alt="Image" src="https://github.com/user-attachments/assets/29b481bb-69c1-4036-9d9a-2db382b67afb" />
...
<img width="920" height="380" alt="Image" src="https://github.com/user-attachments/assets/54fcce18-81d2-41ca-b404-555af66cf498" />
>push 확인 완료
...
```bash
sudo apt install gh
gh auth login --web    #k3s 환경이므로 web으로 접근

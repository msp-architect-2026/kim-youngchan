# 🚀 DropX: High-Concurrency Limited Drop Ordering System

> **"5,000명의 동시 접속자가 100개의 한정판 상품을 구매하는 찰나의 순간, 재고 음수 없이 데이터 정합성을 보장하는 Kubernetes 기반 GitOps 주문 인프라"**
